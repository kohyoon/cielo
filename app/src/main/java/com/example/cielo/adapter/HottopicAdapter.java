...
public class HottopicAdapter extends RecyclerView.Adapter<HottopicAdapter.MyViewholder> {
    ...
    @Override
    public void onBindViewHolder(HottopicAdapter.MyViewholder holder, int position) {
    ...
    public HottopicAdapter(Context context, ArrayList<BoardForm> datalist){
